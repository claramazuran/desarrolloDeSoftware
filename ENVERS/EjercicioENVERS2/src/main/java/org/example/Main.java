...
*/
                    //me recupera la factura de la base de datos
                    Factura facturaRecuperada = manager1.find(Factura.class, 1L);
                    System.out.println("recupere la factura");

                    //cambio el nro de la factura
                    facturaRecuperada.setNumero(85);

                    //en lugar de un persist hacemos un merge, PARA GUARDAR LOS CAMBIOS DE LA FACTURA RECUPERADA, la actualizo
                    manager1.merge(facturaRecuperada);

                    //elimina la factura recuperada
                    manager1.remove(facturaRecuperada);
